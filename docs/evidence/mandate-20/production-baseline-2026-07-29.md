...
- Không claim Done chỉ từ baseline này; RDS drill result thật được ghi riêng trong `rds-pitr-drill-20260729-181943.md`.
...
- docs/evidence/mandate-20/rds-pitr-preflight-20260729.md
...
File này không ghi nhận nội dung video và không thay thế drill result. Drill result thật đã được ghi riêng tại `docs/evidence/mandate-20/rds-pitr-drill-20260729-181943.md`.
...
Done for RDS. Evidence record: rds-pitr-drill-20260729-181943.md. Video links are still pending insertion.
