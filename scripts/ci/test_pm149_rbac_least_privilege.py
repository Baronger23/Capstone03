...
def test_pm149_diff_does_not_touch_flagd_or_unrelated_infrastructure():
    ...
    allowed = {
        ...
        "phase3 - information/techx-corp-chart/templates/_objects.tpl",
            ...
            "phase3 - information/techx-corp-chart/grafana/provisioning/datasources/opensearch.yaml",
        ...
        "docs/evidence/pm-176/03-post-pr474-plugin-signature-failure.md",
            ...
            "docs/evidence/pm-176/05-post-merge-runtime-smoke.md",
    ...
    # content only when the PR also changes something outside the reviewed
    # proxy scope. The subset check keeps this exception fail-closed.
